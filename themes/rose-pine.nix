{
  ...
  config.stylix = {
    ...
    polarity = "dark";
    image = pkgs.fetchurl {
      url = "https://raw.githubusercontent.com/anotherhadi/awesome-wallpapers/main/app/static/wallpapers/a-car-and-a-cloud.png";
      sha256 = "sha256-TOLNbILQlE9m726DILj11jKLd5tZSvdD2YyKTzkSjv0=";
    };
  };
}
